...
private:
   ...
   */
  int compute_Pn(int nMax, double *Wigner, SphericalP<complex<double> > *Pn);
   ...
   * @return 0 if succesful, 1 otherwise (deprecated).
   */
  int compute_Cn(int nMax, int m_, Spherical<double> R, double *Wigner, double *dWigner, SphericalP<complex<double> > *Cn);
   ...
   * @return 0 if succesful, 1 otherwise (deprecated).
   */
  int compute_Bn(int nMax, int m_, Spherical<double> R, double *Wigner, double *dWigner, SphericalP<complex<double> > *Bn);
   ...
   * @return 0 if succesful, 1 otherwise (deprecated).
   */
  int compute_Mn(int nMax, int m_, Spherical<double> R,  complex<double> waveK, double *dn, SphericalP<complex<double> > *Cnm, SphericalP<complex<double> > *Mn, int BHreg);
   ...
   */
  int compute_Nn(int nMax, int m_, Spherical<double> R, complex<double> waveK, double *dn, SphericalP<complex<double> > *Pn,
...
public:
  ...
  SphericalP<complex<double> > *dataMp; /**< The M functions in compound iterator format. */
  SphericalP<complex<double> > *dataNp; /**< The N functions in compound iterator format. */
  SphericalP<complex<double> > *dataBp; /**< The B functions in compound iterator format. */
  SphericalP<complex<double> > *dataCp; /**< The C functions in compound iterator format. */
   ...
   */
  AuxCoefficients(Spherical<double> R_, complex<double> waveK_, int regular_, int nMax_);
   ...
   * @param nMax_ the maximum value of the n iterator.
   */
  void init(Spherical<double> R_, complex<double> waveK_, int regular_, int nMax_);
   ...
   * @return 0 if successful, 1 otherwise.
   */
  int compute_Pp(Spherical<double> R, int nMax, SphericalP<complex<double> > *dataPp);
