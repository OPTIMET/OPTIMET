...
public:
	SphericalP<std::complex<double> > Einc;		/**< The incoming wave values as (0, Einc_the, Einc_phi) in [V/m]. */
	 ...
	 */
	Excitation(unsigned long type_, SphericalP<std::complex<double> > Einc_, Spherical<double> vKInc_, int nMax_);
	 ...
	 * @param nMax_ the maximum value of the n iterator.
	 */
	void init(unsigned long type_, SphericalP<std::complex<double> > Einc_, Spherical<double> vKInc_, int nMax_);
	 ...
	 * @param nMax_ the maximum value of the n iterator.
	 */
	void update(unsigned long type_, SphericalP<std::complex<double> > Einc_, Spherical<double> vKInc_, int nMax_);
	 ...
	 * @return 0 if successful, 1 otherwise.
	 */
	int getIncLocal(Spherical<double> point_, std::complex<double> *Inc_local_, int nMax_);
