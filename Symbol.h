...
public:
   ...
   */
  static double Wigner9j(int j11, int j12, int j13, int j21, int j22, int j23,
   ...
   */
  static std::complex<double> A_0(int m, int n, double R,
   ...
   * @return the A^(0)_(m,n)
   */
  static std::complex<double> A_1(int m, int n, double R,
                                  std::complex<double> waveK_i,
   ...
   * @return the A^(0)_(m,n)
   */
  static std::complex<double> A_m1(int m, int n, double R,
                                   std::complex<double> waveK_i,
                                   std::complex<double> dmn_1);
  ...
  static std::complex<double> up_mn(int m, int n, int nMax_,
                                    std::complex<double> cmn_1,
                                    std::complex<double> dmn_1, double omega_,
                                    Scatterer *object_,
                                    ElectroMagnetic bground_);

  static std::complex<double> vp_mn(int m, int n, int nMax_,
                                    std::complex<double> cmn_1,
                                    std::complex<double> dmn_1, double omega_,
                                    Scatterer *object_,
                                    ElectroMagnetic bground_);

  static std::complex<double> upp_mn(int m, int n, int nMax_,
                                     std::complex<double> cmn_1,
                                     std::complex<double> dmn_1, double omega_,
                                     Scatterer *object_,
                                     ElectroMagnetic bground_);
